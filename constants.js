...
export const LUCKY_LETTERS = [
  ...
  { value: 'P', label: 'P - Phá mẹ là chính', description: 'A fun prank with mom', textOverlay: 'Phá mẹ là chính', getPrompt: () => createFinalPrompt("A lighthearted, playful moment between a child and their mother. Show the child playfully riding a broomstick like a hobby horse, pretending to be a wizard or knight, and playing a fun, harmless prank on their mom. His mother should be reacting with amusement and laughter. The scene should be funny, appropriate, and heartwarming, set within a home decorated for Tet.") },
